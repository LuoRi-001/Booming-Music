...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun newImageLoader(context: PlatformContext): ImageLoader {
        return ImageLoader.Builder(context)
            ...
            .logger(object : Logger {
                override var minLevel = if (BuildConfig.DEBUG) Logger.Level.Verbose else Logger.Level.Warn
    ...
    override fun onTrimMemory(level: Int) {
        ...
        // Only clear the image memory cache on moderate or critical pressure.
        // The low-level TRIM_MEMORY_UI_HIDDEN fires every time the user switches
        // away, which would evict all cached covers unnecessarily. Keeping them
        // warm avoids redundant re-fetches when the user returns to the ranking.
